...
<tiles:insertDefinition name="defaultTemplate">
	...
	<form:form commandName="solicitacao" class="form-horizontal">
	...
	<!-- Text input-->
	<div class="form-group">
	  <label class="col-md-4 control-label" for="data">Data da Autorização</label>  
	  <div class="col-md-4">
	  <input type="text" readonly="readonly" class="form-control input-md" value="${solicitacao.dataAtendimentoFormatada }"/>
	  </div>
	</div>
	...
	<div class="form-group">
	  ...
	  <div class="col-md-4">
	    <a class="btn btn-danger" href="${requestScope['javax.servlet.forward.context_path']}/solicitacao/listar" role="button">Voltar</a>
	  </div>
	</div>
