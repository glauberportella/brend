...
<tiles:insertDefinition name="defaultTemplate">
	...
	<c:url var="addAction" value="/tipoServico/inserir"></c:url>
	<form:form action="${addAction}" commandName="tipoServico" class="form-horizontal">
	...
	<div class="form-group">
	  ...
	  <div class="col-md-4">
	    ...
	    <a class="btn btn-danger" href="${requestScope['javax.servlet.forward.context_path']}/tipoServico/listar" role="button">Cancelar</a>
	  </div>
	</div>
