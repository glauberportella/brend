...
<tiles:insertDefinition name="defaultTemplate">
	...
	<c:url var="addAction" value="/tipoDocumento/inserir"></c:url>
	<form:form action="${addAction}" commandName="tipoDocumento" class="form-horizontal">
	...
	<div class="form-group">
	  ...
	  <div class="col-md-4">
	    ...
	    <a class="btn btn-danger" href="${requestScope['javax.servlet.forward.context_path']}/tipoDocumento/listar" role="button">Cancelar</a>
	  </div>
	</div>
